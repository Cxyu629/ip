 ...
 * 
 * <p>
 * This record encapsulates the structure of a command after it has been parsed from user input or
 * an external source.
 * 
 ...
 * @param params a map of parameter names to their corresponding string values
 */
